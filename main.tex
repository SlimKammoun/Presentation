...
\begin{itemize}
    ...
    \item Objets combinatoires : nombre de cycles, longueurs des cycles, points fixes, suites monotones, descentes etc.
    \item Applications : biologie, combinatoire, processus de coalescence, classification etc. 
\end{itemize}
\item Universalité pour les processus ponctuels (déterminantaux) 
\begin{itemize}
...
\begin{frame}{Tableaux de Young}
   ...
   \end{itemize}
   \end{definition}
   Exemple : les diagramme de Young de taille 3 sont $\mathbb{Y}_3=(3,\underline{0}),(2,1,\underline{0}),(1,1,1,\underline{0})$
...
\begin{frame}{Exaeple d'application : Ewens}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.70\textwidth}
      \begin{center}Ajouter une image (Limit shape par exemple) 
